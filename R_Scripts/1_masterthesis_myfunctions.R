### Master thesis (myfunctions) ----
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Date created:     2020-07-09
# Location created: ALPFOR
# Author:           Raphael S. von Bueren (GitHub: vonbueren)
# Last Entry:       2021-01-21
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Description ----
# Here, the codes of all my self-created functions used in my master thesis are shown.
# 
# Output: my.frost.damage() (R function)
...
my.frost.damage <- function(colnames = c("Nardus_95_BLUETE_1", "Nardus_95_BLUETE_2", "Nardus_95_BLUETE_3"),
  ...
  # Create dataframe
  dat.1           <- data[ c("Temperature", colnames) ]                             # subset specified columns
...
# Function "my.sum.pos" - Add up only positive values --> used for "growing heat summation (GHS)" ----
my.sum.pos <- function(x){sum(x[x>0])}

# Function "my.sum.neg" - Add up only negative values --> used for "freezing summation" ----
my.sum.neg <- function(x){sum(x[x<0])}
